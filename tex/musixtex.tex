...
\def\mufl@x{0.83}%
\def\mxvernumber{115}% make it possible to compare with \ifnum
\def\mxversuffix{-beta4}% optional; Should be empty on fixed version.
\edef\mxversion{T.\mxvernumber\mxversuffix}
\def\mxdate{1 Jan 2011}
