...
\def\comput@fonts{%    
  \ifnum\musicsize=\sixt@@n
    ...
    \def\txtfont{\ifdim\internote<.95\Internote \sevenit
  ...
  \else\ifnum\musicsize=\@xxiv
    ...
    \def\txtfont{\ifdim\internote<.95\Internote \eightit
    \else\ifdim\internote<1.19\Internote \tenit
    \else\ifdim\internote<1.43\Internote \twelveit
    \else\frtit\fi\fi\fi}%
  \else\ifnum\musicsize=\@xxix
    ...
    \let\medppff\ppfftwentynine
    \def\txtfont{\ifdim\internote<.95\Internote \tenit
    \else\ifdim\internote<1.19\Internote \twelveit
    \else\ifdim\internote<1.43\Internote \frtit
    \else\svtit\fi\fi\fi}%
\else
...
\def\pdld{\hbox{\hroff{%
\raise\raiseped\internote\hbox{\vrule height10pt depth0.5pt width0.5pt}%
...
\def\halfwidthbigwedge{4.16666pt}%
...
\raise1.5pt\lrlap{$\bigwedge$}%   pedal up and down
}%
