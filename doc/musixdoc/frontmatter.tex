...
instrumental music\\\Large\itshape Version 1.17}
...
The current version~1.17 (June~2015) incorporates 
corrections to font-selection commands \verb|\txtfont| and \verb|\ppff|,
and to the bar-centering rest commands such as \verb|\centerpause|.
This manual is the definitive reference to all features of
\musixtex\ version~1.17.
